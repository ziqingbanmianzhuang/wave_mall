  ...
  >
    ...
    >
      <view class="specification-wrapper">
        <scroll-view class="specification-wrapper-content" scroll-y="true">
          <view class="specification-header">
            ...
            <view class="specification-right">
              ...
              <view v-if="!hideStock" class="inventory"
                >{{ stockText }}：{{ stockCom }}</view
              >
              <view v-else class="inventory"></view>
              <view v-show="isManyCom" class="choose"
        ...
        <view v-if="showClose != false" class="close" @click="close('close')"
          ><image class="close-item" :src="closeImage"></image
        ></view>
      </view>

      <view v-if="outFoStock || mode == 4" class="btn-wrapper">
      ...
      <view v-else-if="mode == 2" class="btn-wrapper">
        <view
          class="sure add-cart"
          :style="{
            color: themeColorFn('addCartColor'),
      ...
      <view v-else-if="mode == 3" class="btn-wrapper">
        <view
          class="sure"
          :style="{
            color: themeColorFn('buyNowColor'),
